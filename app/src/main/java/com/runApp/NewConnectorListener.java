...
public class NewConnectorListener extends ConnectListenerImpl {
    ...
    public NewConnectorListener(Handler handler, Handler _NewHandler) {
        super(handler, null);
        _OldHandler = handler;
        ...
        _protocol.addZephyrPacketEventListener(new ZephyrPacketListener() {
            public void ReceivedPacket(ZephyrPacketEvent eventArgs) {
                ...
                if (HR_SPD_DIST_PACKET == msg.getMsgID()) {
                    ...
                    double Distance = HRSpeedDistPacket.GetDistance(DataArray);

                    text1 = _aNewHandler.obtainMessage(DISTANCE);
                    b1.putString("Distance", String.valueOf(Distance));
                    text1.setData(b1);
                    _aNewHandler.sendMessage(text1);
                    ...
                    int htbnumber = HRSpeedDistPacket.GetHeartRate(DataArray);
                    System.out.println("HeartBeatNumber is " + htbnumber);
                }
            }
        });
    }
