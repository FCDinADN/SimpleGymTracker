 ...
 * {@link android.database.sqlite.SQLiteDatabase}. Each appended clause is
 * combined using {@code AND}. This class is <em>not</em> thread safe.
 */
public class SelectionBuilder {
    private static final String TAG = LogUtils
            .makeLogTag(SelectionBuilder.class);
    ...
    public Cursor query(boolean distinct, SQLiteDatabase db, String[] columns, String groupBy,
        ...
        LogUtils.LOGD(TAG, "query(columns=" + Arrays.toString(columns) + ") "
                + this);
        return db.query(distinct, mTable, columns, getSelection(), getSelectionArgs(),
